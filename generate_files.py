...
base_dir = r'd:\Yusif\baku-monopoly'
...
os.makedirs(os.path.join(base_dir, 'game'), exist_ok=True)
...
files['game/boardData.js'] = """module.exports = [
...
files['public/game.html'] = """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
files['public/css/main.css'] = """body { background: #1a1a1a; color: white; font-family: sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
.lobby-container { background: #333; padding: 2rem; border-radius: 8px; text-align: center; }
input, button { margin: 10px; padding: 10px; }"""

files['public/css/game.css'] = """body { background: #1a1a1a; color: white; font-family: sans-serif; margin: 0; }
...
files['public/js/lobby.js'] = """const socket = io();
function createRoom() {
...
files['public/js/game.js'] = """console.log('Game UI Initialized');
const socket = io();"""

files['game/cardData.js'] = """module.exports = {
  chance: [],
  communityChest: []
};"""
files['game/gameEngine.js'] = """module.exports = {};"""
files['game/playerColors.js'] = """module.exports = {};"""

files['public/js/board.js'] = """console.log('Board renderer initialized');"""
files['public/js/dice.js'] = """console.log('Dice initialized');"""
files['public/js/cards.js'] = """console.log('Cards initialized');"""
files['public/js/trade.js'] = """console.log('Trade UI initialized');"""
files['public/js/auction.js'] = """console.log('Auction UI initialized');"""

files['public/admin.html'] = """<!DOCTYPE html>
<html>
